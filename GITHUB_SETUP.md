...
The remote is already configured for `defipaca` organization. Just run:
...
**Note:** Make sure the repository `kivoca` exists at `https://github.com/defipaca/kivoca` first!
